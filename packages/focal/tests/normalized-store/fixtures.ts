...
export const candidateProfileResponse: NormalizedStoreResponse = {
	...
	included: [
						...
						artifacts: [
							{
								...
								fileIdentifyingUrlPathSegment:
									"100_100/profile-displayphoto-shrink_100_100/0/1715868936528?e=1741824000&v=beta&t=ByIlOlOUuRkoMRZWGsHKZ5Pm8GA8oQfsRiMgyfH0rwk",
							...
							},
							{
								...
								height: 200,
								fileIdentifyingUrlPathSegment:
									"200_200/profile-displayphoto-shrink_200_200/0/1715868936528?e=1741824000&v=beta&t=y1q6LimbfkmCqXXTAT2XdtXAOD9eVjUHhm2XghrbqUc",
								expiresAt: 1741824000000,
							},
							{
								width: 400,
								height: 400,
								fileIdentifyingUrlPathSegment:
									"400_400/profile-displayphoto-shrink_400_400/0/1715868936528?e=1741824000&v=beta&t=idKGUGcJQQ90xopwwWq9LXFHm3jZv_lfHxIP7zFnZx8",
								expiresAt: 1741824000000,
							},
						],
					},
		...
		// --- Positions ---
		{
			...
			description:
				"Helping companies with Artificial Intelligence solutions keeping their data private. Developed TalentAI, an AI which analyses job candidates and returns a match score.\nIntroducing Blockchain in companies value chain and offering various Blockchain products like a decentralised exchange (DEX), Tokenizer platform and a crowdfunding platform.\nRole: CTO, Product Manager of all products, Agile/Scrum methodologies",
			dateRange: {
		...
		} satisfies PositionEntity,
		{
			...
			description:
				"Lead developer of a KYC application for a large German Bank. (scrum project, tech lead, agile coaching of project team, software architect, VBA development using MS Access connecting to SAP and other external third-party databases, e.g. Schufa, Orbis).",
			dateRange: {
		...
		} satisfies CertificationEntity,
		{
			...
			authority: "Scrum.org",
			displaySource: "dropbox.com",
			url: "https://www.dropbox.com/s/macq9ihogmsbzwb/Scrum%20Master%202020.pdf?dl=0",
		} satisfies CertificationEntity,
		{
			$type: "com.linkedin.voyager.dash.identity.profile.Certification",
			entityUrn:
			...
			url: "https://www.coursera.org/account/accomplishments/specialization/certificate/NNQQLLREMHX6",
		} satisfies CertificationEntity,
